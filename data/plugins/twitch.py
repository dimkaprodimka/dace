# -*- coding: utf-8 -*-
#-plugin-sig:
import argparse
import json
import logging
import re
...
from ACEStream.PluginsContainer.streamlink.exceptions import NoStreamsError, PluginError, StreamError
...
from ACEStream.PluginsContainer.streamlink.plugin.api.utils import parse_json, parse_query
from ACEStream.PluginsContainer.streamlink.stream import (
    HTTPStream, HLSStream, FLVPlaylist, extract_flv_header_tags
)
from ACEStream.PluginsContainer.streamlink.stream.hls import HLSStreamReader, HLSStreamWriter, HLSStreamWorker
from ACEStream.PluginsContainer.streamlink.stream.hls_playlist import M3U8Parser, load as load_hls_playlist
from ACEStream.PluginsContainer.streamlink.utils.times import hours_minutes_seconds
