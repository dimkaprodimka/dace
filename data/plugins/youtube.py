#-plugin-sig:
...
from ACEStream.PluginsContainer.streamlink.compat import is_py2, parse_qsl, urlparse, urlunparse
from ACEStream.PluginsContainer.streamlink.plugin import Plugin, PluginError, PluginArguments, PluginArgument, AccessDeniedError
from ACEStream.PluginsContainer.streamlink.plugin.api import validate, useragents
from ACEStream.PluginsContainer.streamlink.plugin.api.utils import itertags, parse_query
...
from ACEStream.PluginsContainer.streamlink.utils import parse_json, search_dict
from ACEStream.PluginsContainer.streamlink.utils.encoding import maybe_decode
