#-plugin-sig:
...
from ACEStream.PluginsContainer.streamlink.utils import memoize
from ACEStream.PluginsContainer.streamlink.compat import urlparse, parse_qsl
from ACEStream.PluginsContainer.streamlink.utils.times import seconds_to_hhmmss
